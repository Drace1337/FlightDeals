...
class AmadeusService:
    ...
    def search_flights(self, origin_iata, destination_iata, departure_date, return_date, adults):
        headers = {"Authorization": f"Bearer {self.token}"}
        params = {
        ...
        response = requests.get(self.flight_offers_endpoint, headers=headers, params=params)
        response.raise_for_status()
